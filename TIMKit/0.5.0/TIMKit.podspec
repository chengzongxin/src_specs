...
TODO: Add long description of the pod here.
  ...
  s.subspec 'RongIM' do |kit|
    kit.subspec 'RongIMKit' do |im|
      ...
      im.dependency 'RongCloudIM/IMLib', '2.9.19'
    end
  ...
  s.subspec 'IMKit' do |kit|
    ...
    kit.dependency 'AFNetworking', '~> 2.6.3'
    kit.dependency 'MJExtension', '~> 3.0.17'
    kit.dependency 'YYWebImage'
    kit.dependency 'Masonry'
    kit.dependency 'MBProgressHUD', '~> 0.9.1'
    kit.dependency 'FMDB', '2.4'
    kit.dependency 'SPAlertController', '2.5.2'
    
    kit.dependency 'AMap3DMap'
    kit.dependency 'AMapSearch'
    kit.dependency 'AMapLocation'
