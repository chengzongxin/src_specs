...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'http://repo.we.com/tubroker/timkit.git', :commit => '716ee2f3' }
  ...
  s.subspec 'IMKit' do |kit|
    ...
    kit.dependency 'AMap3DMap', '8.0.1'
    kit.dependency 'AMapSearch', '7.9.0'
    kit.dependency 'AMapLocation', '2.7.0'
    
    kit.dependency 'MGSwipeTableCell', '1.6.11'
    kit.dependency 'GKPhotoBrowser/YY', '~> 2.0.0'
    kit.dependency 'Godeye', "1.1.0"
