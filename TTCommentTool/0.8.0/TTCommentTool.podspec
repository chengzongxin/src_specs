Pod::Spec.new do |s|
  ...
  s.source           = { :git => "http://repo.we.com/ios/tbtrepo.git", :commit => "440999e39cb37433155fd2b1cbccedb19e25ce12" }
  s.platform         = :ios, '8.0'
  s.requires_arc     = true
  s.prefix_header_contents = '#import "TBasicLib.h"'
    ...
    s.subspec 'CoinTask' do |t|
        t.source_files = 'TTCommentTool/Pod/CoinTask/*.{h,m}'
    end
    
    s.dependency 'TBasicLib'
    s.dependency 'THKCustomHUD'
    s.dependency 'TCoinTaskModule'
