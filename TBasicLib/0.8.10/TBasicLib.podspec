...
Pod::Spec.new do |s|
  ...
  s.source           = { :git => "http://repo.we.com/ios/tbtrepo.git", :tag => "0.7.16" }
  s.platform     = :ios, '8.0'
  s.requires_arc = true
  ...
  s.subspec 'XLog' do |xlog|
    xlog.source_files = 'TBasicLib/Pod/Classes/XLog/*.{h,m,mm}'
    xlog.frameworks       = ['SystemConfiguration', 'CoreTelephony']
    xlog.libraries        = ['z','stdc++','c++']
    xlog.vendored_frameworks = 'TBasicLib/Pod/Classes/XLog/mars.framework'
  end
