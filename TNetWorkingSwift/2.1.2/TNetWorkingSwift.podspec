...
#   * Finally, don't worry about the indent, CocoaPods strips it!
  ...
  s.homepage         = 'http://repo.we.com/iosbaselibraries/TSwiftRepo.git'
  # s.screenshots     = 'www.example.com/screenshots_1', 'www.example.com/screenshots_2'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'anyeler.zhang' => 'anyeler.zhang@corp.to8to.com' }
  s.source           = { :git => 'http://repo.we.com/iosbaselibraries/TSwiftRepo.git', :tag => '0.3.1' }
  ...
  s.source_files = 'TNetWorkingSwift/Classes/*.swift'
  s.requires_arc = true
  ...
  s.subspec 'Core' do |ba|
    ba.source_files = 'TNetWorkingSwift/Classes/Core/*.swift'
  end
