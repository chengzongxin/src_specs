Pod::Spec.new do |s|
  ...
  s.version          = "3.3.6"
  s.summary          = "土巴兔社交库"
  s.description      = "修改https://api.weixin.qq.com/sns/userinfo接口返回结果取值错误"
  s.homepage         = "http://repo.we.com/ios/tbtrepo"
  s.license          = 'MIT'
  s.author           = { "kevin.huang" => "kevin.huang@corp.to8to.com" }
  s.source           = { :git => "http://repo.we.com/ios/tbtrepo.git", :commit => '72200e2' }
  s.platform     = :ios, '9.0'
  s.requires_arc = true
  ...
  s.dependency 'TBTCustomView', '0.2.1.1'
