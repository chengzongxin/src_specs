Pod::Spec.new do |s|
  ...
  s.source           = { :git => "http://repo.we.com/ios/im.git", :tag => "2.6.1" }
  s.platform     = :ios, '8.0'
  s.requires_arc = true
...
#s.dependency 'TBasicLib', '>=0.4.9'
  ...
  s.dependency 'TGetPictures', '~>0.5.4'
  s.dependency 'FMDB/SQLCipher', '2.4'
  s.dependency 'AliyunOSSiOS', '~> 2.6.0'
  s.dependency 'YYCache', '~> 1.0.4'
  s.dependency 'YYImage', '~> 1.0.4'

s.vendored_frameworks = ['IM/lib/AMapFoundationKit.framework','IM/lib/AMapSearchKit.framework','IM/lib/MAMapKit.framework']
s.frameworks = ['GLKit','OpenGLES','CoreGraphics','QuartzCore','CoreLocation','CoreTelephony','SystemConfiguration','Security','AdSupport','JavaScriptCore', 'AMapFoundationKit', 'AMapSearchKit', 'MAMapKit']
...
s.xcconfig = {
'FRAMEWORK_SEARCH_PATHS' => '$(inherited) $(PODS_ROOT)/IM/lib/AMapFoundationKit $(PODS_ROOT)/IM/lib/AMapSearchKit  $(PODS_ROOT)/IM/lib/MAMapKit',
