...
#
# 此模块为基础UI组件模块，包含三大基础控制器，BaseViewController,BaseNavigationControoler,BaseWebViewController,BaseTabBarController
...
TODO: Add long description of the pod here.
  ...
  s.resource_bundles = {
    'TBaseUISwift' => ['TBaseUISwift/Assets/*.xcassets',
                   'TBaseUISwift/Assets/*.png',
                   'TBaseUISwift/Assets/*.bundle']
 }
