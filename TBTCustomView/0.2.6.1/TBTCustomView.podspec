...
TODO: Add long description of the pod here.
  ...
  s.source           = { :git => 'http://repo.we.com/ios/tbtrepo.git', :commit => "c13bc807" }
  ...
  s.dependency 'TTabBarController', '0.2.2'
  s.dependency 'TOldBasicClass', '0.2.3'
  # s.dependency 'TBTCategory', '0.1.4' 移除TBTCategory，使用TMUIKit
