...
TODO: Add long description of the pod here.
  ...
  #s.source           = { :git => "http://repo.we.com/ios/tbtrepo.git", :tag => "0.10.29" }
  s.source           = { :git => "http://repo.we.com/ios/tbtrepo.git", :commit => 'aeb7ad84' }
